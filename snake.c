...
//global variables for rows,coloumns,score,etc.
int i,j,Field[N][M],x,y,Gy,Head,Tail,Game,Frogs,a,b,var,dir,score,HighScore,Speed,n;
...
void Random()
{
    ...
    if(Frogs == 0 && Field[a][b]==0){
        Field[a][b]= -1;
        Frogs = 1;
        if(Speed>10 && score!=0) Speed = Speed - n;
    }
}
